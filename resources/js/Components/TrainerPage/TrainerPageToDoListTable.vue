...
const addTodo = () => {
  ...
  router.post(route('trainerClientToDoList.store'), {
    title: newTodo.value,
...
const updateTodoStatus = (todo) => {
   router.put(route('trainerClientToDoList.update', todo.id), {
...
const submit = () => {
  editForm.put(route('trainerClientToDoList.update', editForm.id), {
    onSuccess: () => {
    editForm.reset();
...
const deleteToDoList = () => {
  deleteForm.delete(route('trainerClientToDoList.destroy', deleteForm.id), {
    onError: (errors) => {
