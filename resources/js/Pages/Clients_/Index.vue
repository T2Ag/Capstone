                     ...
                     <tbody>
                        <tr v-for="client in clients.data" :key="client.id" class="text-center ">
                           ...
                           <td class="items-center my-auto align-middle py-3 px-3">
                              ...
                              <button type="button" class=" text-green-500 mx-2" :data-bs-toggle="'modal'" :data-bs-target="`#editModal-${client.id}`">
                                 <i class="bi bi-pencil text-[1.3rem]"></i>
                              </button>        

                              <!-- <button class="text-red-600 " type="button" @click="openDeleteModal(client)" data-bs-toggle="modal" data-bs-target="#deleteModal">
