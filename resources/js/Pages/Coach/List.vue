               ...
               <tbody>
                  <tr v-for="coach in coaches.data" :key="coach.id" class="text-center ">
                     ...
                     <td class="flex items-center justify-center p-2">
                        ...
                        <button type="button" class="rounded text-green-500 text-[15px]" :data-bs-toggle="'modal'" :data-bs-target="`#editModal-${coach.id}`">
                           <i class="bi bi-pencil"></i>
                        </button>
   
                        <EditCoachModal :coach="coach" :key="`editModal-${coach.id}`" />
   
                        <button class="text-red-600 mx-3 " type="button" @click="openDeleteModal(coach)" data-bs-toggle="modal" data-bs-target="#deleteModal">
